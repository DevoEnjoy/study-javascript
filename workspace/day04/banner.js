...
imageDiv.forEach((div, i) => div.style.backgroundImage = `url(banner/00${i+1}.png)`)

banner.appendChild(lastImageDiv);
lastImageDiv.style.backgroundImage = `url(banner/001.png)`;

banner.insertBefore(firstImageDiv, document.querySelector("div.banner div"));
firstImageDiv.style.backgroundImage = `url(banner/00${imageDiv.length}.png)`
